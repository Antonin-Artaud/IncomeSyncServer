namespace IncomeSync.Presentation.Tests.Unit.Endpoints;

using System.Threading.Tasks;
using IncomeSync.Application.Authors.Entities;
using IncomeSync.Application.Common.Exceptions;
using IncomeSync.Application.Movies.Entities;
using MediatR;
